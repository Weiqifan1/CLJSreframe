...
* [`src/cljs/forsog4/`](src/cljs/forsog4/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/forsog4/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `forsog4` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/forsog4/config.cljs) defaults to `true` in
...
```clj
(ns forsog4.example
  (:require [forsog4.config :as config])
